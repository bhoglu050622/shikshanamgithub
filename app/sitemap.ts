...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  // Course pages (actual courses with page.tsx files)
  const coursePages = [
    {
      url: `${baseUrl}/courses/sanskrit-bhasha-pragya`,
      lastModified: now,
      changeFrequency: 'weekly' as const,
      priority: 0.8,
    },
    {
      url: `${baseUrl}/courses/chanakya-code`,
      lastModified: now,
      changeFrequency: 'weekly' as const,
      priority: 0.8,
    },
    {
      url: `${baseUrl}/courses/advaita-vedanta`,
      lastModified: now,
      changeFrequency: 'weekly' as const,
      priority: 0.7,
    },
    ...
    {
      url: `${baseUrl}/courses/isha-upanishad-course`,
      lastModified: now,
      changeFrequency: 'weekly' as const,
      priority: 0.7,
    },
    ...
    {
      url: `${baseUrl}/courses/durgasaptashi`,
      lastModified: now,
      changeFrequency: 'weekly' as const,
      priority: 0.7,
    },
    {
      url: `${baseUrl}/courses/yoga-darshan-course`,
      lastModified: now,
      changeFrequency: 'weekly' as const,
      priority: 0.7,
    },
