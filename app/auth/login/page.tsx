...
export const metadata: Metadata = {
  title: 'Login - Shikshanam',
  description: 'Sign in to your Shikshanam account to continue your Sanskrit learning journey.',
}
        ...
        <div className="max-w-md mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-saffron-600 to-saffron-700 hover:from-saffron-700 hover:to-saffron-800 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                Sign In
              </button>
            </form>
