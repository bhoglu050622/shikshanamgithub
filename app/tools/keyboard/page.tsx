...
export const metadata: Metadata = {
  title: 'Devanagari Keyboard Helper - Shikshanam | Sanskrit Typing Tool',
  description: 'Learn to type in Devanagari script with our interactive keyboard helper and typing practice tool.',
}
      ...
      <div className="container-custom py-20">
        <div className="text-center">
          <h1 className="text-hero bg-gradient-to-r from-saffron-600 via-deep-teal-600 to-indigo-600 bg-clip-text text-transparent mb-6">
            Devanagari Keyboard Helper
          </h1>
          <p className="text-subheading text-indigo-700 dark:text-wisdom-200 max-w-2xl mx-auto">
            Coming soon - Interactive Devanagari typing tool and practice exercises.
          </p>
        </div>
      </div>
    </div>
