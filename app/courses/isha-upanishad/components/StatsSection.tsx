...
export default function StatsSection() {
  ...
  const stats = [
    ...
    },
    {
      number: 95,
      suffix: '%',
      label: 'Spiritual Clarity Achieved'
    }
  ];
  ...
  return (
    <div id="isha-info-section-rethemed" ref={sectionRef}>
      ...
      <svg width="0" height="0" style={{ position: 'absolute' }}>
        <defs>
          <linearGradient id="pinkGradientThemed" x1="0%" y1="0%" x2="0%" y2="100%">
        ...
        <div className="info-card text-center p-8 md:p-12 mb-12 content-item">
          <div className="mb-6">
            <svg width="40" height="40" viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg" className="opacity-95 mx-auto">
              <circle cx="40" cy="40" r="18" fill="url(#pinkGradientThemed)" />
            </svg>
          </div>
          <p className="text-2xl md:text-3xl font-playfair text-main leading-snug mb-4">
            With the right guidance, you can <br /> 
            <span className="text-accent uppercase text-3xl md:text-4xl">UNDERSTAND ALL 5 CONCEPTS!</span>
          </p>
          <p className="text-secondary italic mb-8">
            Step by step, we'll help you transcend confusion, with the wisdom of Isha Upanishad.
          </p>
