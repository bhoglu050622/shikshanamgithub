    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 dark:bg-wisdom-900/95 backdrop-blur-md border-t border-saffron-200/30 dark:border-saffron-400/20 shadow-lg"
        >
