...
export default function PrashnaUpanishadCoursePage() {
  const features = [
    ...
    { icon: <ScrollText className="h-8 w-8 text-purple-600" />, text: "All Ques Covered", subtitle: "6 Questions" },
    { icon: <Bell className="h-8 w-8 text-purple-600" />, text: "Free Future Updates", subtitle: "Lifetime Access" },
    { icon: <FileCheck className="h-8 w-8 text-purple-600" />, text: "Certification", subtitle: "Certificate" },
  ];
                  ...
                  <div className="relative bg-white p-2 rounded-3xl shadow-2xl border-4 border-white transform group-hover:scale-105 transition-transform duration-500">
                    <div className="relative overflow-hidden rounded-2xl">
                        <Image 
                            ...
                            onError={(e) => { (e.target as HTMLImageElement).onerror = null; (e.target as HTMLImageElement).src='https://placehold.co/600x600/9333ea/white?text=Prashna+Upanishad'; }}
                        />
                    </div>
                  </div>
                </div>
          ...
          <div className="text-center lg:text-left order-2 lg:order-2">
            ...
            <div className="inline-block mb-4">
              <div className="flex items-center gap-2 bg-gradient-to-r from-purple-100 to-pink-100 px-4 py-2 rounded-full border-2 border-purple-200 animate-pulse">
                ...
                <span className="text-purple-700 font-bold text-sm">6 Profound Questions • Eternal Answers</span>
              </div>
            </div>

            <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-4 leading-tight">
              <span className="bg-gradient-to-r from-slate-900 via-purple-800 to-pink-800 bg-clip-text text-transparent">
                Online Course on The Prashna Upanishad
              </span>
            </h1>
            ...
            <p className="text-xl md:text-2xl text-purple-700 font-bold mb-8 italic flex items-center justify-center lg:justify-start gap-2">
              <span className="text-2xl">🔮</span> जीवन के सबसे गहन प्रश्नों की यात्रा पर निकलें ! <span className="text-2xl">🔮</span>
            </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            ...
            <div className="group bg-gradient-to-br from-pink-50 to-purple-50 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-2 border-pink-200 hover:border-pink-400">
              ...
              <p className="text-center text-slate-900 font-bold text-lg leading-tight">
                ब्रह्माण्ड में जीवन कैसे प्रारम्भ हुआ?
              </p>
            </div>
            ...
            <div className="group bg-gradient-to-br from-pink-50 to-purple-50 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-2 border-pink-200 hover:border-pink-400">
              ...
              <p className="text-center text-slate-900 font-bold text-lg leading-tight">
                हमारे शरीर में प्राण कैसे कार्य करता है?
              </p>
            </div>
            ...
            <div className="group bg-gradient-to-br from-pink-50 to-purple-50 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-2 border-pink-200 hover:border-pink-400">
              ...
              <p className="text-center text-slate-900 font-bold text-lg leading-tight">
                क्या निद्रा में हम अस्तित्व से मिलते हैं?
              </p>
            </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-4 leading-tight">
              तो आज ही जुड़ें प्रश्न उपनिषद् से!
            </h2>
            <p className="text-lg md:text-xl text-pink-100 max-w-3xl mx-auto">
              Rishi Pippalada shares six profound answers to 6 fundamental questions
            </p>
          </div>
            ...
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden transform hover:scale-105 transition-transform duration-500">
              <div className="relative aspect-video">
                <iframe
                  width="100%"
                  height="100%"
                  src="https://www.youtube.com/embed/tsMquy2nzc0?autoplay=0&rel=0&modestbranding=1"
                  title="Exploring the Teachings of Prashna Upanishad"
                  frameBorder="0"
                ...
                <div className="flex items-center justify-between flex-wrap gap-4">
                  <div>
                    <h3 className="text-2xl font-bold text-slate-900 mb-2">
                      Exploring the Teachings of Prashna Upanishad
                    </h3>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">
              ...
              <span className="bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent">जिज्ञासुओं</span>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-12">
            ...
            <div className="group bg-gradient-to-br from-pink-50 to-purple-50 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-2 border-pink-100 hover:border-pink-300 text-center">
              ...
              <p className="text-5xl font-extrabold text-pink-600 mb-2">950+</p>
            ...
            <div className="group bg-gradient-to-br from-pink-50 to-purple-50 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-2 border-pink-100 hover:border-pink-300 text-center">
              ...
              <p className="text-5xl font-extrabold text-pink-600 mb-2">130+</p>
            ...
            <div className="order-1 lg:order-2 space-y-8">
              ...
              <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg border-2 border-purple-100 space-y-4">
                <p className="text-slate-700 leading-relaxed text-lg">
                  ...
                  अपने प्रतिष्ठान के चलते, उन्होंने हजारों लोगों के कार्य करने का निर्णय लिया।
                </p>
                <p className="text-slate-700 leading-relaxed text-lg">
                  भारतीय दर्शनों के साथ साथ आध्यात्मिक और धार्मिक विषयों को वैज्ञानिक दृष्टिकोण से प्रस्तुत करने की उनकी पद्धति हेतु
                  Hyper Quest चैनल का निर्माण किया जो भारत के शीर्ष युवा चैनलों में से एक है। विशाल जी के माध्यम से विभिन्न वार्ग आज लगभग 2 million लोगों तक पहुंच रहे हैं और अपनी भारतीय भी संस्कृति में हैं।
                </p>
                <p className="text-slate-700 leading-relaxed text-lg">
                  संक्षेप में, विशाल जी का उद्देश्य प्राचीन ज्ञान और दर्शन को मनोवैज्ञानिक और आध्यात्मिक विद्याओं के माध्यम से लोगों के लिए उपयोगी बनाना है।
                </p>
              </div>
      ...
      <div className="bg-white py-16 md:py-24">
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-5xl mx-auto space-y-6">
              ...
              <div className="bg-gradient-to-r from-pink-600 to-purple-600 px-6 md:px-8 py-5 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="text-xl md:text-2xl font-bold text-white">
                    Introduction : प्रश्न उपनिषद् क्या है ? ( Free Demo Video)
                  </h3>
                </div>
              ...
              <div className="p-6 md:p-8">
                <div className="bg-white rounded-2xl shadow-lg overflow-hidden mb-6">
                  <div className="flex items-center gap-3 px-6 py-4 bg-slate-50 border-b-2 border-slate-200">
                    <PlayCircle className="h-5 w-5 text-pink-600" />
                    <p className="text-slate-700 font-semibold">Duration - 00:04:57</p>
                  </div>
                  ...
                  <div className="relative aspect-video">
                    <iframe
                      ...
                      height="100%"
                      src="https://www.youtube.com/embed/tsMquy2nzc0?autoplay=0&rel=0&modestbranding=1"
                      title="Prashna Upanishad Free Demo"
                      frameBorder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                      allowFullScreen
                      className="absolute inset-0"
            ...
            {/* Additional Chapters */}
            {[
              { title: "प्रश्न 4: सुषुप्ति में कौन सोता है और कौन जागता है?", duration: "1 hr", chapters: "08" },
              { title: "प्रश्न 5: ॐंकार के निरंतर चिंतन से किस लोक की प्राप्ति होगी ?", duration: null, chapters: null },
              { title: "प्रश्न 6: सोलह कलाओं वाला पुरुष कौन है ?", duration: null, chapters: null },
            ].map((question, index) => (
                  ...
                  {question.duration && (
                    <div className="flex items-center gap-4 text-slate-600">
                      <div className="flex items-center gap-2">
                        ...
                        <p className="text-sm font-semibold">Duration : {question.duration}</p>
                      </div>
                      {question.chapters && (
                        <div className="flex items-center gap-2">
                          <ScrollText className="h-4 w-4" />
                          <p className="text-sm font-semibold">Total Chapters : {question.chapters}</p>
                        </div>
                      )}
                    </div>
                  )}
          ...
          <div className="max-w-5xl mx-auto mt-12">
            <div className="bg-gradient-to-br from-purple-600 to-pink-600 rounded-3xl shadow-2xl p-8 md:p-12 text-white text-center">
              ...
              <p className="text-lg md:text-xl mb-8 leading-relaxed">
                Explore 6 profound questions of the Prashna Upanishad with detailed explanations, philosophical insights, and practical applications for modern life.
              </p>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border-2 border-white/20">
                  <p className="text-4xl font-extrabold mb-2">6</p>
                  <p className="text-sm font-semibold">Questions Covered</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border-2 border-white/20">
