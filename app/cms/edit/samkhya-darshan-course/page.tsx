...
export default function SamkhyadarshancourseEditor() {
  ...
  const fetchContent = async () => {
    try {
      const response = await fetch('/api/cms/samkhya-darshan-course');
      if (response.ok) {
        ...
        setContent({
          hero: {
            ...
            subtitle: 'Samkhya Darshan - The Philosophy of Numbers and Categories',
            description: 'Explore this comprehensive course designed to provide deep understanding and practical application.',
            image: '/images/courses/samkhya-darshan-course.jpg',
            ctaText: 'Enroll Now',
            ctaLink: '/courses/samkhya-darshan'
          },
          syllabus: {
