...
export default function ParaaparabundleEditor() {
  ...
  const fetchContent = async () => {
    try {
      const response = await fetch('/api/cms/para-apara-bundle');
      if (response.ok) {
        ...
        setContent({
          hero: {
            ...
            image: '/images/packages/para-apara-bundle.jpg',
            ctaText: 'Get This Bundle',
            ctaLink: '/packages/para-apara-bundle'
          },
          courses: {
            ...
            testimonials: [
              {
                ...
                rating: 5,
                course: 'Parā + Aparā Courses Bundle'
              }
            ]
          },
          faq: {
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h1 className="text-xl font-semibold text-gray-900">
                    Parā + Aparā Courses Bundle Editor
                  </h1>
