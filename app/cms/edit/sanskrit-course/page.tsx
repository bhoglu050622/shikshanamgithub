...
export default function SanskritcourseEditor() {
  ...
  const fetchContent = async () => {
    try {
      const response = await fetch('/api/cms/sanskrit-course');
      if (response.ok) {
