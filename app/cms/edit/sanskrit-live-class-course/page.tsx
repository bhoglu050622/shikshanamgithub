...
export default function SanskritliveclasscourseEditor() {
  ...
  const fetchContent = async () => {
    try {
      const response = await fetch('/api/cms/sanskrit-live-class-course');
      if (response.ok) {
        ...
        setContent({
          hero: {
            ...
            subtitle: 'Sanskrit Live Class - Interactive Learning',
            description: 'Explore this comprehensive course designed to provide deep understanding and practical application.',
            image: '/images/courses/sanskrit-live-class-course.jpg',
            ctaText: 'Enroll Now',
            ctaLink: '/courses/sanskrit-live-class'
          },
          syllabus: {
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h1 className="text-xl font-semibold text-gray-900">
                    Sanskrit Live Class Course Editor
                  </h1>
