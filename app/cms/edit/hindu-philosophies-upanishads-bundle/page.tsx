...
export default function HinduphilosophiesupanishadsbundleEditor() {
  ...
  const fetchContent = async () => {
    try {
      const response = await fetch('/api/cms/hindu-philosophies-upanishads-bundle');
      if (response.ok) {
            ...
            testimonials: [
              {
                ...
                rating: 5,
                course: 'Hindu Philosophies + Upanishads Bundle'
              }
            ]
          },
          faq: {
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h1 className="text-xl font-semibold text-gray-900">
                    Hindu Philosophies + Upanishads Bundle Editor
                  </h1>
