...
export default function AdvaitaVedantaCourseEditor() {
  ...
  const fetchContent = async () => {
    try {
      const response = await fetch('/api/cms/advaita-vedanta-course');
      if (response.ok) {
        ...
        setContent({
          hero: {
            ...
            description: 'Explore the profound philosophy of non-dualism and discover the true nature of reality through ancient wisdom.',
          ...
          syllabus: {
            ...
            description: 'Comprehensive curriculum covering all essential topics of Advaita Vedanta',
            modules: [
              {
                id: 'module-1',
                title: 'Introduction to Advaita Vedanta',
                description: 'Understanding the fundamentals of non-dual philosophy',
                duration: '2 weeks',
                lessons: [
                  { title: 'What is Advaita Vedanta?', duration: '45 min' },
                  { title: 'Key Concepts and Terminology', duration: '60 min' }
                ]
              },
              {
                id: 'module-2',
                title: 'Drig Drishya Viveka - The Seer and the Seen',
                description: 'Deep dive into the core text and its teachings',
                duration: '3 weeks',
                lessons: [
                  { title: 'Understanding the Seer', duration: '60 min' },
                  { title: 'The Nature of the Seen', duration: '45 min' },
                  { title: 'The Distinction Between Them', duration: '60 min' }
                ]
              }
            ]
          },
          outcomes: {
            ...
            benefits: [
              ...
              'Cultural and historical context of Indian philosophy'
            ]
          },
          testimonials: {
            ...
            testimonials: [
              {
                ...
                content: 'This course provided deep insights into Advaita Vedanta with modern relevance.',
                rating: 5
              }
            ]
          },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {previewMode ? (
          <ContentPreview 
            contentId="advaita-vedanta-course"
            ...
            <div className="lg:col-span-3">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                <EnhancedContentEditor
                  ...
                  onSave={async (data) => {
                    updateContent(activeSection, data);
                    return true;
                  }}
                  fields={[]}
                  title={activeSection}
                  description={`Edit ${activeSection} section`}
                />
              </div>
            </div>
          </div>
