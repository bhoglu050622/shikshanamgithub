...
export default function VaisheshikdarshancourseEditor() {
  ...
  const fetchContent = async () => {
    try {
      const response = await fetch('/api/cms/vaisheshik-darshan-course');
      if (response.ok) {
        ...
        setContent({
          hero: {
            ...
            subtitle: 'Vaisheshik Darshan - The Philosophy of Particularity',
            description: 'Explore this comprehensive course designed to provide deep understanding and practical application.',
            image: '/images/courses/vaisheshik-darshan-course.jpg',
            ctaText: 'Enroll Now',
            ctaLink: '/courses/vaisheshik-darshan'
          },
          syllabus: {
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h1 className="text-xl font-semibold text-gray-900">
                    Vaisheshik Darshan Course Editor
                  </h1>
