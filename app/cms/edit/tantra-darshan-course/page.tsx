...
export default function TantradarshancourseEditor() {
  ...
  const fetchContent = async () => {
    try {
      const response = await fetch('/api/cms/tantra-darshan-course');
      if (response.ok) {
        ...
        setContent({
          hero: {
            ...
            subtitle: 'Tantra Darshan - Ancient Tantric Philosophy',
            description: 'Explore this comprehensive course designed to provide deep understanding and practical application.',
            image: '/images/courses/tantra-darshan-course.jpg',
            ctaText: 'Enroll Now',
            ctaLink: '/courses/tantra-darshan'
          },
          syllabus: {
