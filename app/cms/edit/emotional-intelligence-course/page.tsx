...
export default function EmotionalintelligencecourseEditor() {
  ...
  const fetchContent = async () => {
    try {
      const response = await fetch('/api/cms/emotional-intelligence-course');
      if (response.ok) {
        ...
        setContent({
          hero: {
            ...
            subtitle: 'Emotional Intelligence with Samkhya Darshan',
            description: 'Explore this comprehensive course designed to provide deep understanding and practical application.',
            image: '/images/courses/emotional-intelligence-course.jpg',
            ctaText: 'Enroll Now',
            ctaLink: '/courses/emotional-intelligence-with-samkhya-darshan'
          },
          syllabus: {
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h1 className="text-xl font-semibold text-gray-900">
                    Emotional Intelligence Course Editor
                  </h1>
