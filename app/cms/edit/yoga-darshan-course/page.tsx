...
export default function YogadarshancourseEditor() {
  ...
  const fetchContent = async () => {
    try {
      const response = await fetch('/api/cms/yoga-darshan-course');
      if (response.ok) {
        ...
        setContent({
          hero: {
            ...
            subtitle: 'Yoga Darshan - The Philosophy of Union and Liberation',
            description: 'Explore this comprehensive course designed to provide deep understanding and practical application.',
            image: '/images/courses/yoga-darshan-course.jpg',
            ctaText: 'Enroll Now',
            ctaLink: '/courses/yoga-darshan'
          },
          syllabus: {
