...
export default function NyayadarshancourseEditor() {
  ...
  const fetchContent = async () => {
    try {
      const response = await fetch('/api/cms/nyaya-darshan-course');
      if (response.ok) {
        ...
        setContent({
          hero: {
            ...
            subtitle: 'Nyaya Darshan - Logic and Reasoning in Indian Philosophy',
            description: 'Explore this comprehensive course designed to provide deep understanding and practical application.',
            image: '/images/courses/nyaya-darshan-course.jpg',
            ctaText: 'Enroll Now',
            ctaLink: '/courses/nyaya-darshan'
          },
          syllabus: {
