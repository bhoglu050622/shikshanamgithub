...
export default function ParabundleEditor() {
  ...
  const fetchContent = async () => {
    try {
      const response = await fetch('/api/cms/para-bundle');
      if (response.ok) {
        ...
        setContent({
          hero: {
            ...
            image: '/images/packages/para-bundle.jpg',
            ctaText: 'Get This Bundle',
            ctaLink: '/packages/para-bundle'
          },
          courses: {
            ...
            testimonials: [
              {
                ...
                rating: 5,
                course: 'All Parā Courses Bundle'
              }
            ]
          },
          faq: {
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h1 className="text-xl font-semibold text-gray-900">
                    All Parā Courses Bundle Editor
                  </h1>
