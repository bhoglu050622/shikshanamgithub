        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none">
            <div className="bg-white rounded-2xl p-8 shadow-lg mb-8">
              <h2 className="font-serif text-2xl font-bold text-gray-900 mb-4 text-center">1. Information We Collect</h2>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg mb-8">
              <h2 className="font-serif text-2xl font-bold text-gray-900 mb-4 text-center">2. How We Use Your Information</h2>
              <p className="font-sans text-gray-600 mb-4 text-justify">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg mb-8">
              <h2 className="font-serif text-2xl font-bold text-gray-900 mb-4 text-center">3. Information Sharing</h2>
              <p className="font-sans text-gray-600 mb-4 text-justify">
                We do not sell, trade, or otherwise transfer your personal information to third parties except in the following circumstances:
              </p>
              <ul className="font-sans list-disc list-inside text-gray-600 space-y-2">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg mb-8">
              <h2 className="font-serif text-2xl font-bold text-gray-900 mb-4 text-center">4. Data Security</h2>
              <p className="font-sans text-gray-600 mb-4 text-justify">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg mb-8">
              <h2 className="font-serif text-2xl font-bold text-gray-900 mb-4 text-center">5. Your Rights</h2>
              <p className="font-sans text-gray-600 mb-4 text-justify">
