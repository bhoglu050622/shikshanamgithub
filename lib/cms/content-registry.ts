...
export const CONTENT_TYPES: Record<string, ContentTypeConfig> = {
  ...
  sanskritDarshanUpanishadBundle: {
    ...
    frontendPath: '/courses/sanskrit-darshan-upanishad-bundle',
    type: 'PackageContent',
    status: 'active',
    category: 'education',
  ...
  sanskritPhilosophyBundle: {
    ...
    frontendPath: '/courses/sanskrit-philosophy-bundle',
    type: 'PackageContent',
    status: 'active',
    category: 'education',
    features: ['hero', 'courses', 'pricing', 'benefits', 'testimonials', 'faq'],
  ...
  hinduPhilosophiesUpanishadsBundle: {
    ...
    frontendPath: '/courses/hindu-philosophies-upanishads-bundle',
    type: 'PackageContent',
    status: 'active',
    category: 'education',
    features: ['hero', 'courses', 'pricing', 'benefits', 'testimonials', 'faq'],
  ...
  paraAparaBundle: {
    ...
    frontendPath: '/courses/para-apara-bundle',
    type: 'PackageContent',
    status: 'active',
    category: 'education',
    features: ['hero', 'courses', 'pricing', 'benefits', 'testimonials', 'faq'],
  ...
  paraBundle: {
    ...
    frontendPath: '/courses/para-bundle',
    type: 'PackageContent',
    status: 'active',
    category: 'education',
    features: ['hero', 'courses', 'pricing', 'benefits', 'testimonials', 'faq'],
