...
const nextConfig = {
  ...
  // Disable devtools to fix setAttribute error
  devIndicators: {
    buildActivity: false,
  ...
  webpack: (config, { isServer, dev }) => {
    ...
    config.plugins.push(
      new (require('webpack')).DefinePlugin({
        'global.SVGElement': 'typeof SVGElement !== "undefined" ? SVGElement : class SVGElement {}',
        'global.HTMLElement': 'typeof HTMLElement !== "undefined" ? HTMLElement : class HTMLElement {}',
        'global.Element': 'typeof Element !== "undefined" ? Element : class Element {}',
        'global.Node': 'typeof Node !== "undefined" ? Node : class Node {}',
        'global.Document': 'typeof Document !== "undefined" ? Document : class Document {}',
        'global.Window': 'typeof Window !== "undefined" ? Window : class Window {}',
      })
    );
  ...
  // Disable devtools and experimental features
  experimental: { 
