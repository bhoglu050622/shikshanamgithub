...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({
    ...
    const baseClasses = cn(
      ...
      {
        // Primary - Brand primary color with proper contrast
        'bg-primary hover:bg-primary/90 text-primary-foreground shadow-[0_4px_14px_rgba(255,138,0,0.1)] hover:shadow-[0_6px_20px_rgba(255,138,0,0.15)] hover:scale-[1.02] active:scale-[0.98]': variant === 'primary',
        
        // Secondary - Clean white/dark background with border
        'bg-secondary text-secondary-foreground border border-border hover:bg-secondary/80 shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.08)] hover:scale-[1.02] active:scale-[0.98]': variant === 'secondary',
        
        // Outline - Primary border
        'border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground hover:scale-[1.02] active:scale-[0.98] bg-transparent': variant === 'outline',
        
        // Ghost - Transparent with subtle hover
        'text-primary hover:bg-primary/10 hover:scale-[1.02] active:scale-[0.98] bg-transparent': variant === 'ghost',
        
        // Link - Text only with primary accent
        'text-primary hover:text-primary/80 p-0 h-auto bg-transparent': variant === 'link',
        
        // Destructive - Error styling
        'bg-destructive hover:bg-destructive/90 text-destructive-foreground shadow-[0_4px_14px_rgba(220,38,38,0.1)] hover:shadow-[0_6px_20px_rgba(220,38,38,0.15)] hover:scale-[1.02] active:scale-[0.98]': variant === 'destructive',
      },
