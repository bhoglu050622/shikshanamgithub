    ...
    <div className="absolute inset-0 overflow-hidden -z-10">
      ...
      {sanskritSymbols.map((symbol, index) => {
        ...
        return (
          <FloatingSymbol
            ...
            delay={index * 0.5}
            duration={8 + (index % 3)}
            positionClass={`top-${position.top}% left-${position.left}%`}
      ...
      {Array.from({ length: 20 }).map((_, index) => {
        ...
        const positions = [
          ...
          { top: 40, left: 75 }, { top: 50, left: 35 }, { top: 60, left: 65 },
          { top: 70, left: 20 }, { top: 80, left: 80 }, { top: 15, left: 45 },
          { top: 25, left: 55 }, { top: 35, left: 10 }, { top: 45, left: 90 },
          { top: 55, left: 30 }, { top: 65, left: 70 }, { top: 75, left: 40 },
          { top: 85, left: 60 }, { top: 12, left: 50 }, { top: 22, left: 35 },
          { top: 32, left: 65 }, { top: 42, left: 80 }
        ];
        const position = positions[index % positions.length];
