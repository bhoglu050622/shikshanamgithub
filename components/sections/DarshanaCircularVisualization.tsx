...
const steps: Step[] = [
  {
    ...
    comic: '/assets/darshana-journey/maya-nyaya.jpg',
    icon: Brain
  },
  {
    id: 'vaisheshika',
    ...
    comic: '/assets/darshana-journey/maya-vaisheshika.jpg',
    icon: Atom
  },
  {
    id: 'samkhya',
    ...
    comic: '/assets/darshana-journey/maya-samkhya.jpg',
    icon: Eye
  },
  {
    id: 'yoga',
    ...
    comic: '/assets/darshana-journey/maya-yoga.jpg',
    icon: Heart
  },
  {
    id: 'mimamsa',
    ...
    comic: '/assets/darshana-journey/maya-mimamsa.jpg',
    icon: Scale
  },
  {
    id: 'vedanta',
    ...
    comic: '/assets/darshana-journey/maya-vedanta.jpg',
    icon: Lightbulb
  }
]
    ...
    >
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-body text-wisdom-600 dark:text-wisdom-400 max-w-3xl mx-auto mb-6">
            Each darshana offers a unique perspective on reality, yet together they form a complete understanding of existence, consciousness, and the path to liberation.
          </p>
