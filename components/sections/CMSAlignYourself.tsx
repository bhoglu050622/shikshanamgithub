...
export default function CMSAlignYourself() {
  const mounted = useHydrationSafeAnimation()
      ...
      <section id="align-yourself" className="section-padding bg-background relative overflow-hidden">
        <div className="container-custom relative z-10">
          <div className="animate-pulse">
            ...
            <div className="h-6 bg-muted rounded mb-16"></div>
  ...
  return (
    <section id="align-yourself" className="section-padding bg-background relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        ...
        >
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6">
            {content.alignYourself.title}
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            {content.alignYourself.subtitle}
          </p>
        </motion.div>
        ...
        >
          <CourseCarousel 
            courses={content.alignYourself.liveClasses} 
            type="live" 
            title="Latest Live Classes" 
          />
          <CourseCarousel 
            courses={content.alignYourself.selfPacedCourses} 
            type="self-paced" 
