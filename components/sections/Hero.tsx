        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <Link
              ...
              className="group relative overflow-hidden rounded-2xl bg-white/70 dark:bg-gray-800/70 backdrop-blur-lg border border-orange-200/50 dark:border-orange-700/50 p-8 hover:scale-105 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-500/20"
            >
            ...
            <Link
              ...
              className="group relative overflow-hidden rounded-2xl bg-white/70 dark:bg-gray-800/70 backdrop-blur-lg border border-amber-200/50 dark:border-amber-700/50 p-8 hover:scale-105 transition-all duration-300 hover:shadow-2xl hover:shadow-amber-500/20"
            >
