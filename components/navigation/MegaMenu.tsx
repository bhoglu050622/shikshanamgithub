          ...
          <div className="fixed top-16 left-0 right-0 bottom-0 pointer-events-none">
            ...
            <div className="max-w-screen-2xl mx-auto px-4 h-full flex items-start justify-center pointer-events-auto">
              <motion.div
                ...
                className="w-full max-w-6xl bg-white dark:bg-wisdom-900 rounded-2xl shadow-2xl border border-saffron-200/30 dark:border-saffron-400/20 max-h-[calc(100vh-5rem)] overflow-hidden"
                role="dialog"
                aria-label="Navigation menu"
                aria-modal="true"
              >
                <div className="flex flex-col min-h-[400px] max-h-[calc(100vh-6rem)]">
                  {/* Main Content Row */}
                  <div className="flex flex-1 min-h-0">
                    {/* Left Navigation */}
                    <div className="w-64 bg-gradient-to-b from-saffron-50 to-saffron-100 dark:from-wisdom-800 dark:to-wisdom-900 rounded-l-2xl p-6 flex flex-col">
                            ...
                            <div className="flex items-start space-x-6 p-6 bg-gradient-to-r from-saffron-50 to-saffron-100 dark:from-wisdom-800 dark:to-wisdom-700 rounded-2xl">
                              ...
                              <div className="flex-1">
                                ...
                                <motion.button
                                  onClick={() => {
                                    try {
                                      if (currentGroup.featured.href.startsWith('http')) {
                                        window.location.href = currentGroup.featured.href
                                      } else {
                                        router.push(currentGroup.featured.href)
                                      }
                                    } catch (error) {
                                ...
                                <div className="space-y-3">
                                  {column.links.map((link, linkIndex) => (
                                    <motion.button
                                      ...
                                      whileHover={{ x: 4 }}
                                      className="block p-3 rounded-xl hover:bg-saffron-50 dark:hover:bg-wisdom-800 transition-all duration-200 group w-full text-left"
                                    >
                  ...
                  <div className="flex items-center justify-between px-8 py-4 border-t border-saffron-200/30 dark:border-saffron-400/20 bg-saffron-50/50 dark:bg-wisdom-800/50 rounded-b-2xl">
