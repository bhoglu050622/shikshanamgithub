...
import { GRAPHY_CONFIG } from '@/lib/auth/GraphySSO'
...
export function UserDropdown() {
  ...
  const handleMyLearningHub = () => {
    window.open(GRAPHY_CONFIG.LEARNING_HUB_URL, '_blank')
    setIsOpen(false)
  }

  const handleMyJourney = () => {
    // Navigate to journey page (you can customize this route)
